...
function MapPopup({
    ...
    return (
        <LeafletPopup
            className={cn(
                "bg-popover text-popover-foreground animate-in fade-out-0 fade-in-0 zoom-out-95 zoom-in-95 slide-in-from-bottom-2 rounded-md border font-sans shadow-md outline-hidden",
                className
            )}
            {...props}
        />
